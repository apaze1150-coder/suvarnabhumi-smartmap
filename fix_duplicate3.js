...
if (startIdx !== -1) {
    ...
    `;
        ...
        fs.writeFileSync(file, before + newLogic + after, 'utf8');
        console.log('Fixed successfully by completely replacing the block.');
    } else {
        console.log('Could not find </script>');
    }
} else {
    console.log('Could not find // Boutique Logic');
}
